...
import com.poterion.monitor.notifiers.raspiw2812.data.LightColor
...
fun main(args: Array<String>) {
	SerialPortCommunicator.findCommunicator()?.apply {
		...
		listOf(LightConfig(pattern = "lighthouse",
				color1 = LightColor(16, 0, 0),
				color2 = LightColor(0, 16, 0),
				color3 = LightColor(0, 0, 16),
				color4 = LightColor(16, 16, 0),
				color5 = LightColor(0, 16, 16),
				color6 = LightColor(16, 0, 16),
